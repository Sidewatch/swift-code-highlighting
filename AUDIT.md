...
- 25 Sep 2026 — nine more rule tables (BibTeX, DOT, EdgeQL, go.mod, MANIFEST.MF, Meson, Quarto/R Markdown, .strings, Texinfo); `YAMLStructure.site(in:path:)` (`YAMLEditSiteTests`; the mutant that returns the wrapping node's range fails).
